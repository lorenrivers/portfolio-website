...
export default function HomePage() {
  return (
    <div>
      <section className="h-5/6 sm:h-fit bg-teal-600 text-white gradient-background">
        {/* Intro Hero Section */}
      ...
      <section className="h-5/6 sm:h-fit sm:pt-20">
        {/* About Section */}
        <p className="px-4 min-[400px]:px-10 pt-10 text-justify font-roboto">
        ...
        <p className="px-4 min-[400px]:px-10 py-5 text-justify font-roboto">
        ...
        <p className="px-4 min-[400px]:px-10 py-5 font-roboto">
